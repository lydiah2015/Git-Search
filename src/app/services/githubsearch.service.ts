          ...
          if(res.length>0){
            for(var i=0; i<res.length;i++){
              this.profileRepos.push(
                new Repository(res[i].name,res[i].html_url,res[i].description,res[i].stargazers_count,
          ...
          if(res.total_count>0){
            for(var i=0; i<res.items.length;i++){
              ...
              this.searchedRepos.push(
                new Repository(res.items[i].name,res.items[i].html_url,res.items[i].description,res.items[i].stargazers_count,
